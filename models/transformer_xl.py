...
if __name__ == '__main__':
    ...
    parser.add_argument('--n_layer', type=int, default=2, help='')      # Original default 4
    parser.add_argument('--n_rel_layer', type=int, default=2, help='')  # Original default 4
    ...
    import tf_xl_utils.data_utils as data_utils
